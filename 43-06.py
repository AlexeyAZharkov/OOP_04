...
class Agency:
    ...
    def add_object(self, ob):
        self.agency_lst.append(ob)

    def remove_object(self, ob):
        self.agency_lst.remove(ob)

    def get_objects(self):
        return self.agency_lst
...
lst_houses = list(filter(lambda x: isinstance(x, Flat), ag.get_objects()))
print(lst_houses)# выделение списка домов

'''
Вам поручено организовать представление объектов для продажи в риэлтерских агентствах. Для этого в программе 
