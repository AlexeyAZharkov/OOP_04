...
'''
Наследование часто используют, чтобы вынести общий код дочерних классов в базовый класс. Сделаем такой пример.
...
в формате (height, length) высота и длина - вещественные числа.
